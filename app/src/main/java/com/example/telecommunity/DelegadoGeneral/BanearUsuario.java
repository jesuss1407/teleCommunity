...
public class BanearUsuario extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_banear_usuario);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.navigation_estadistica) {
                    ...
                    // Ir a la actividad AdministrarDonaión
                    Intent intent = new Intent(BanearUsuario.this, VerUsuario.class);
